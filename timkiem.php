...
<table width="997" border="1" align="center">
  <tr>
    <td width="373" height="63" background="img/076.jpg" bgcolor="#FFFF99"><div align="left" class="style16 style71 style74 style12">
      <div align="center"><?php echo "Tên Sách";?></div>
    </div></td>
    <td width="244" background="img/076.jpg" bgcolor="#FFFF99"><div align="center" class="style16 style71 style74 style12">
      <div align="center"><?php echo "Tên Tác Giả";?></div>
    </div></td>
    <td width="157" background="img/076.jpg" bgcolor="#FFFF99"><div align="center" class="style16 style71 style74 style12"><?php echo "Số Lượng Còn";?></div></td>
    <td width="133" background="img/076.jpg" bgcolor="#FFFF99"><span class="style16 style71 style74 style 12" align="center"><?php echo "Thể Loại";?></span></td>
    <td width="56" background="img/076.jpg" bgcolor="#FFFF99"><div align="center" class="style16 style71 style74"><?php echo " ";?></div></td>
  </tr>
</table>
<?php
	$dem=1;
...
<form action="muon.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
  ...
  <div align="center" class="style24">
    <input name="tensach" readonly="False" value="<?php echo $row["tensach"];?>" type="text" size="45" />
