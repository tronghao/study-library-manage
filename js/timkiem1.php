...
.style44 {font-size: 23px; color: #000000; font-weight: bold; }
.style46 {font-size: 20px; color: #000000; font-weight: bold; }
.abc{opacity: 0.8;
...
<table width="997" border="1" align="center">
  <tr>
    ...
    <td width="229" bgcolor="#FFFF99"><div align="center" class="style16">
      <div align="center"><?php echo "Tên Tác Giả";?></div>
    </div></td>
    <td width="156" bgcolor="#FFFF99"><div align="center" class="style16"><?php echo "Số Lượng Còn";?></div></td>
    <td width="142" bgcolor="#FFFF99"><span class="style23">&nbsp;<?php echo "Thể Loại";?></span></td>
    <td width="54" bgcolor="#FFFF99"><div align="center" class="style16"><?php echo " ";?></div></td>
  </tr>
</table>
<?php
	$dem=1;
