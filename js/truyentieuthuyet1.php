...
.style16 {font-family: "VNI-AlgerianU"; font-size: 20px; color: #333333; }
...
<table width="991" border="0" align="center">
 ...
 <table width="50" border="0" align="center">
  <tr>
    <td height="10" colspan="2" align="right" valign="bottom" bgcolor="#FFFFFF"><form action="timkiem1.php" method="post" name="form1" class="style6" id="form1">
...
<table width="999" border="0" align="center">
  <tr>
    ...
    <td width="993" height="63" bordercolor="#0000FF" bgcolor="#FFCC99" class="style11 style12"><div align="center"><?php echo "Không Tìm Thấy";?></div></td>
  </tr>
</table>
<p>
  <?php
...
<p>
  <?php
	...
	if (mysqli_num_rows($result1) > 0)
	{
		 ...
		 {
		 	if ($row["theloai"] == "Tiểu Thuyết" || $row["theloai"] == "Truyện" || $row["theloai"] == "Truyện Kiếm Hiệp" || $row["theloai"] == "Truyện Tiên Hiệp" ||$row["theloai"] == "Truyện Ngôn Tình") 
			{
...
<table width="997" border="1" align="center">
  <tr>
    <td width="404" height="63" bgcolor="#FFFF99"><div align="left" class="style16">
      <div align="center"><?php echo "Tên Sách";?></div>
    </div></td>
    <td width="213" bgcolor="#FFFF99"><div align="center" class="style16">
      <div align="center"><?php echo "Tên Tác Giả";?></div>
    </div></td>
    <td width="157" bgcolor="#FFFF99"><div align="center" class="style16"><?php echo "Số Lượng Còn";?></div></td>
    <td width="133" bgcolor="#FFFF99"><span align="center" class="style16">&nbsp;<?php echo "Thể Loại";?></span></td>
    <td width="56" bgcolor="#FFFF99"><div align="center" class="style16 style69"><?php echo " ";?></div></td>
  </tr>
</table>
<?php
	$dem=1;
...
?>
<form action="muon.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
  <label></label>
  <label></label>
  <label></label>
  <label></label>
  ...
  <div align="center" class="style24">
    <input name="tensach" readonly="False" value="<?php echo $row["tensach"];?>" type="text" size="51" />
    <input name="tentacgia" readonly="False" value="<?php echo $row["tentacgia"];?>" type="text" size="28" />
    <input name="soluong" readonly="False" value="<?php echo $row["soluong"];?>" type="text" size="18" />
    <input name="theloai" readonly="False" value="<?php echo $row["theloai"];?>" type="text" size="16" />
    <input type="submit" name="Mượn" value="Mượn" />
  </div>
</form>
<?php
			$dem=1;}
...
<table width="999" border="0" align="center">
  <tr>
    ...
    <td width="993" bordercolor="#0000FF" bgcolor="#FFCC99" class="style11 style12"><div align="center"><?php echo "Không Tìm Thấy";?></div></td>
  </tr>
</table>
<?php
	}
