...
<table width="500" border="0" align="center">
  <tr>
    <td width="496" height="27" colspan="2" bgcolor="#660099"><div align="center"><span class="style68">NHAÄP THOÂNG TIN CAÀN THIEÁT </span></div></td>
    </tr>
  <tr>
    <td colspan="2" align="center" valign="middle" bgcolor="#FFFFCC">
		<form id="form2" name="form2" method="post" action="tdmk.php">
            <br>
			<label> <span class="style36 style71">Mật khẩu cũ:</span>
            <input type="password" name="mkc" />
            </label>
			</br>
			<br>
            <label><span class="style36 style72">Mật khẩu mới:</span>
