...
.style21 {font-family: "VNI-Lithos"; font-size: 18px; color: #FFFF00; }
.style23 {color: #6600FF; font-size: 19px; font-family: "Times New Roman", Times, serif; }
.style24 {font-family: "VNI-Lithos"; font-size: 16px; }
.style25 {
	font-size: 20px;
	color: #000000;
	font-weight: bold;
...
.style15 {color: #CCFFFF}
.style16 {color: #FFFFFF}
.style17 {color: #000000; font-size: 20px;}
...
<div style="clear:both;"></div>
<div class="shadow-left2"></div>
<div class="shadow-left3"></div>
...
<table width="998" border="0" align="center">
  <tr>
    <td width="933" colspan="2" bgcolor="#FFFFFF" class="style9">
      <p align="center"><span class="style14">Chức năng - nhiệm vụ</span></p>
      <p align="justify"><span class="style8"><span class="style15"><span class="style16"><span class="style17"><strong>1.</strong> Thư viện Trường Đại học Trà Vinh có chức năng cung ứng các tài liệu, sản phẩm thông tin phục vụ nhu cầu hoạt động giảng dạy, học tập, đào tạo, nghiên cứu khoa học, ứng dụng tiến bộ khoa học thông qua việc sử dụng, khai thác các loại tài liệu có trong Thư viện (tài liệu chép tay, in, sao chụp, khắc trên mọi chất liệu, tài liệu điện tử, tài liệu số hóa,...).</span></span></span></span></p>
      <p align="justify" class="style17"><strong>2. Thư viện Trường Đại học Trà Vinh có những nhiệm vụ sau đây</strong></p>
      <p align="justify" class="style17">a) Tham mưu giúp Hiệu trưởng nhà trường xây dựng quy hoạch phát triển, kế hoạch hoạt động dài hạn và ngắn hạn của Thư viện; tổ chức điều phối toàn bộ hệ thống thông tin, tư liệu, Thư viện trong nhà Trường;</p>
      <p align="justify" class="style17">b) Bổ sung, phát triển nguồn lực thông tin trong nước và nước ngoài đáp ứng nhu cầu giảng dạy, học tập, nghiên cứu khoa học; thu nhận các tài liệu do nhà trường xuất bản, các công trình nghiên cứu khoa học đã được nghiệm thu, kỷ yếu hội thảo, khóa luận, luận văn thạc sỹ, luận án tiến sỹ của viên chức, giảng viên, sinh viên, học viên; chương trình đào tạo, giáo trình, tài liệu giảng dạy và các dạng tài liệu khác của nhà Trường, các ấn phẩm tài trợ, biếu tặng, tài liệu trao đổi giữa các Thư viện;</p>
      <p align="justify" class="style17">c) Tổ chức xử lý, sắp xếp, lưu trữ, bảo quản, quản lý tài liệu; xây dựng hệ thống tra cứu tích hợp; thiết lập mạng lưới truy nhập và tìm kiếm thông tin tự động hóa; xây dựng các cơ sở dữ liệu điện tử; biên soạn, xuất bản các ấn phẩm thông tin theo quy định của Pháp luật;</p>
      <p align="justify" class="style17">d) Tổ chức phục vụ, hướng dẫn cho bạn đọc khai thác, tìm kiếm, sử dụng hiệu quả nguồn tài liệu và các sản phẩm dịch vụ Thông tin - Thư viện thông qua các hình thức phục vụ của Thư viện phù hợp với quy định của pháp luật;</p>
      <p align="justify" class="style17">đ) Nghiên cứu, ứng dụng thành tựu khoa học công nghệ tiên tiến và công nghệ thông tin vào công tác Thư viện;</p>
      <p align="justify" class="style17">e) Xây dựng quy hoạch, kế hoạch, tổ chức bồi dưỡng chuyên môn, nghiệp vụ, ngoại ngữ, tin học cho viên chức Thư viện để phát triển nguồn nhân lực có chất lượng nhằm nâng cao hiệu quả công tác;</p>
      <p align="justify" class="style17">f) Tổ chức quản lý viên chức, tài sản theo sự phân cấp của Hiệu trưởng; bảo quản, kiểm kê định kỳ vốn tài liệu, trang thiết bị cơ sở vật chất kỹ thuật và tài sản khác của Thư viện, tiến hành thanh lọc, đề nghị thanh lý tài liệu lạc hậu, hư hỏng theo quy định;</p>
      <p align="justify" class="style17">g) Thực hiện báo cáo tình hình hoạt động hàng năm và báo cáo đột xuất khi có yêu cầu của các cấp có thẩm quyền.</p>
      <p align="justify" class="style17"><strong>3. Thư viện trường Đại học Trà Vinh có quyền hạn sau đây</strong></p>
      <p align="justify" class="style17">a) Tham gia các hội nghề nghiệp, các hội nghị, hội thảo khoa học về Thông tin Thư viện trong nước và quốc tế; liên kết, hợp tác với các Thư viện, tổ chức cá nhân trong nước và ngoài nước về tiếp nhận tài trợ, viện trợ, trao đổi nguồn lực thông tin, kinh nghiệm chuyên môn, tham gia các mạng thông tin phù hợp với quy định của Nhà trường và của pháp luật;</p>
    <p align="justify" class="style17">b) Tổ chức các hoạt động dịch vụ có thu phí phù hợp với quy định của pháp luật và chức năng nhiệm vụ được giao;</p>      <p align="justify" class="style17">c) Từ chối tiếp nhận và phục vụ các loại tài liệu trái với quy định của pháp luật; trái với Nội quy, Quy định của Thư viện, của Trường.</p></td>
  </tr>
</table>
</div>
...
<form action="timkiem.php" method="post" name="form1" class="style6" id="form1">
...
<table width="363" border="1">
        <tr>
          <td width="353" bgcolor="#6600CC"><div align="center"><span class="style21">Thoâng tin lieân heä </span></div></td>
        </tr>
      </table>
	   <p align="center" class="style19"><span class="style23">Số 126 - Nguyễn Thiện Thành, Khóm 4, phường 5, Thành phố Trà Vinh.</span></p>
      <p align="center" class="style19"><span class="style23">Số điện thoại: 01206663784.</span></p>
    <p align="center" class="style24" >Giôø môû cöûa: 7.0 AM - 20 pm </p>
</li>
</ul>
</ul>
</div>
