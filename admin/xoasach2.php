...
<table width="991" border="0" align="center">
 ...
 <table width="806" border="0" align="center">
  <tr>
    ...
    <td width="372" bgcolor="#FFCC66"><div align="center" class="style10 style82">Nhập tên sách cần xóa: </div></td>
    <td width="518" background="img/030.jpg" class="style9"><form id="form2" name="form2" method="post" action="xoasach2.php">
      <div align="center">
        <input name="tensach" type="text" size="30" />
...
<table width="992" border="0" align="center">
  <tr>
    <td width="982"><form id="form2" name="form2" method="post" action="xoas.php">
      <label></label>
      <label></label>
      <label></label>
        ...
        <div align="center">
          <label>
          <input name="tensach" type="text" value="<?php echo $row1["tensach"];?>" size="40" readonly="False" />
          <input name="tentacgia" type="text" value="<?php echo $row1["tentacgia"];?>" size="30" readonly="False" />
          <input name="soluong" type="text" value="<?php echo $row1["soluong"];?>" size="7" readonly="False" />
          </label>
          <input name="theloai" readonly="False" value="<?php echo $row1["theloai"];?>" type="text" size="15" />
...
<table width="575" border="0" align="center">
  <tr>
    ...
    <td width="569" height="71" align="center" valign="middle" bordercolor="#0000FF" bgcolor="#0000FF" class="style12 style11 style84">&nbsp; <?php echo "KHÔNG TÌM THẤY";?></td>
  </tr>
</table>
<?php
	}
