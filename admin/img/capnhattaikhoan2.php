...
<table width="991" border="0" align="center">
 ...
 <table width="806" border="0" align="center">
   <tr>
     <td width="796" align="center" valign="middle" background="img/030.jpg"><label><span class="style39 style78"><br />
        <form id="form2" name="form2" method="post" action="capnhattaikhoan3.php">
	    <p align="center">
          <label></label>
        </p>
      <label><span class="style39">Tài Khoản cần cập nhật:</span>
       <input name="usenamecu" readonly="False" value="<?php echo $_POST["usename"];?>" type="text" size="35" />
        </label>
        <label>
        <input name="passwordcu" readonly="False" value="<?php echo $_POST["password"];?>" type="text" size="20" />
        </label>
        <label>
        <input name="hotencu" readonly="False" value="<?php echo $_POST["hoten"];?>" type="text" size="10" />
        </label>
        <label>
        <input name="lopcu" readonly="False" value="<?php echo $_POST["lop"];?>" type="text" size="15" />
	    </label>
        
        <p>
          <label>
          <div align="center" class="style44">HÃY NHẬP THÔNG TIN CẦN CẬP NHẬT </div>
          </label>
        </p>
        <p align="center">
          <label><span class="style7 style76">Usename:</span>
          <input type="text" name="usenamemoi" />
		  </label>
		  <label>
          <span class="style7"><br />
          <br />
          <span class="style78"><span class="style81">Password</span>:</span></span>
          <input type="text" name="passwordmoi" />
          </label>
        </p>
        <p align="center">
          <label><span class="style43 style81"><span class="style84">Họ Tên</span>:</span>
          <input type="text" name="hotenmoi" />
          </label>
        </p>
        <p align="center">
          <label><span class="style43 style79">Học Lớp:</span>
          <input type="text" name="lopmoi" />
          </label>
        </p>
        <p align="center">  
