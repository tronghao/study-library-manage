...
<table width="991" border="0" align="center">
 ...
 <table width="806" border="0" align="center">
  <tr>
    ...
    <td width="372" bgcolor="#FFCC66"><div align="center" class="style10 style82">Nhập tên tài khoản cần cập nhật: </div></td>
    <td width="518" background="img/030.jpg" class="style9"><form id="form2" name="form2" method="post" action="capnhattaikhoan2.php">
      <div align="center">
...
<table width="992" border="0" align="center">
  <tr>
    <td width="982"><form id="form2" name="form2" method="post" action="capnhattaikhoan2.php">
      <label></label>
      <label></label>
      <label></label>
        ...
        <div align="center">
          ...
          <input name="usename" type="text" value="<?php echo $row1["usename"];?>" size="15" readonly="False" />
	      <input type="text" name="password" value="<?php echo $row1["password"];?>" size="15" readonly="False" />
          <input name="hoten" type="text" value="<?php echo $row1["hoten"];?>" size="30" readonly="False" />
          <input name="lop" type="text" value="<?php echo $row1["lop"];?>" size="10" readonly="False" />
          </label>
...
<table width="575" border="0" align="center">
  <tr>
    ...
    <td width="569" height="51" align="center" valign="middle" bordercolor="#0000FF" bgcolor="#0000FF" class="style12 style11 style84">&nbsp; <?php echo "KHÔNG TÌM THẤY";?></td>
  </tr>
</table>
</br>
<?php
