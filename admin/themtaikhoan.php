...
.style79 {font-size: 20px}
.style84 {font-size: 15px}
.style85 {font-size: 17px}
 ...
 <table width="806" border="0" align="center">
   <tr>
     <td width="796" align="center" valign="middle" background="img/030.jpg"><label><span class="style39 style78"><br />
        <form id="form2" name="form2" method="post" action="themtk.php">
          <label>
          <p>&nbsp;</p>
          <div align="center" class="style44 style79 style82">HÃY NHẬP THÔNG TIN CẦN THIẾT </div>
          </label>
        </p>
        <p align="center">
          <label><span class="style7 style76"> Tài Khoản:</span>
          <input type="text" name="usename" />
		  </label>
		  <label>
          <span class="style7"><br />
          <br />
          <span class="style76">Mật Khẩu:</span></span>
          <input type="text" name="password" />
          </label>
        </p>
        <p align="center">
          <label><span class="style43 style85">Họ Tên:</span>
          <input type="text" name="hoten" />
          </label>
        </p>
        <p align="center">
          <label><span class="style43 style84">Học Lớp:</span>
          <input type="text" name="lop" />
          </label>
        </p>
        <p align="center">  
          <input type="submit" name="Cập Nhật" value="Thêm" />
        </p>
      </form>
       </p>
       <p align="center">&nbsp;</p>
