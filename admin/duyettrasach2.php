...
<table width="575" border="0" align="center" bordercolor="#0000FF">
  <tr>
    ...
    <td width="569" height="50" align="center" valign="middle" bordercolor="#0000FF" bgcolor="#0000FF" class="style12 style11 style8 style84 style85">&nbsp; <?php echo "ĐÃ TÌM THẤY";?></td>
  </tr>
</table>
<?php $dem=1;}?>
<table width="992" border="0" align="center">
  <tr>
    <td width="982"><form id="form2" name="form2" method="post" action="trasach.php">
      <label></label>
      <label></label>
      <label></label>
        ...
        <div align="center">
          <label>
               <input name="usename" type="text" value="<?php echo $row1["usename"];?>" size="5" readonly="False" />
          ...
          <input name="tensach" readonly="False" value="<?php echo $row1["tensach"];?>" type="text" size="25" />
          <input name="tentacgia" readonly="False" value="<?php echo $row1["tentacgia"];?>" type="text" size="15" />
<?php if($row1["datem"]!=="0000-00-00"){?>
<input name="daduyet" readonly="False" value="<?php echo "Đã Duyệt";?>" type="text" size="4" />
<input name="datet" readonly="False" value="<?php echo date("d-m-Y",strtotime($row1["datet"]))?>" type="text" size="6" />
<?php
$startdate=getdate();
								$dateT=$startdate['year']."-".$startdate['mon']."-".$startdate['mday'];
								$datekt = strtotime($dateT); 
								$datet = strtotime($row1["datet"]); 
								if($datekt>$datet){
?>								
<input name="TB" type="text" class="style7" value="<?php  echo "QUÁ HẠN";?>" size="5" readonly="False" />						
<?php }} else{?>
<input name="chuaduyet" readonly="False" value="<?php echo "Chưa Duyệt";?>" type="text" size="15" />
<?php }?>
          <input type="submit" name="Submit" value="Duyệt Trả" />
...
<table width="575" border="0" align="center">
  <tr>
    ...
    <td width="569" height="50" align="center" valign="middle" bordercolor="#0000FF" bgcolor="#0000FF" class="style12 style11 style8 style84 style85">&nbsp; <?php echo "TÀI KHOẢN CHƯA MƯỢN SÁCH";?></td>
  </tr>
</table>
<?php } ?>
 <p><br />
