...
<table width="991" border="0" align="center">
 ...
 <table width="806" border="0" align="center">
  <tr>
    ...
    <td width="372" bgcolor="#FFCC66"><div align="center" class="style10 style82">Nhập user cần kiểm tra: </div></td>
    <td width="518" background="img/030.jpg" class="style9"><form id="form2" name="form2" method="post" action="tracuumuon2.php">
      <div align="center">
  ...
  <tr>
    <td width="982"><form id="form2" name="form2" method="post" action="duyetmuon.php">
        <div align="center">
          ...
          <input name="tensach" readonly="False" value="<?php echo $row1["tensach"];?>" type="text" size="30" />
...
<table width="575" border="0" align="center" bordercolor="#0000FF">
  <tr>
    ...
    <td width="569" height="45" align="center" valign="middle" bordercolor="#0000FF" bgcolor="#0000FF" class="style11 style8 style82 style83">&nbsp; <?php echo "TÀI KHOẢN CHƯA MƯỢN SÁCH";?></td>
  </tr>
</table>
<?php } ?>
 <p><br />
