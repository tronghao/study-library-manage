 ...
 <table width="806" border="0" align="center">
   <tr>
     <td width="796" align="center" valign="middle" background="img/030.jpg"><label><span class="style39 style78"><br />
        <form id="form2" name="form2" method="post" action="capnhatsach.php">
	    <p align="center">
          <label></label>
        </p>
      <label><span class="style39">Sách bạn cần cập nhật:</span>
       <input name="tensachcu" readonly="False" value="<?php echo $_POST["tensach"];?>" type="text" size="35" />
        </label>
        <label>
        <input name="tentacgiacu" readonly="False" value="<?php echo $_POST["tentacgia"];?>" type="text" size="20" />
        </label>
        <label>
        <input name="soluongcu" readonly="False" value="<?php echo $_POST["soluong"];?>" type="text" size="10" />
        </label>
        <label>
        <input name="theloaicu" readonly="False" value="<?php echo $_POST["theloai"];?>" type="text" size="15" />
	    </label>
        ...
        <p align="center">
          <label><span class="style7 style76">Tên Sách:</span>
          <input type="text" name="tensachmoi" />
		  </label>
		  <label>
          <span class="style7"><br />
          <br />
          <span class="style78">Tác Giả:</span></span>
          <input type="text" name="tentacgiamoi" />
          </label>
        </p>
        <p align="center">
          <label><span class="style43 style81">Số Lượng:</span>
          <input type="text" name="soluongmoi" />
          </label>
        </p>
        <p align="center">
          <label><span class="style43 style79">Thể Loại:</span>
